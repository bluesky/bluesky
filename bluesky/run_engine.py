...
class RunEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self._run_bundlers: typing.Dict[
            typing.Any, RunBundler
        ...
        try:
            ...
            for p in self._plan_stack:
                try:
                    ...
                    print(
                        "The plan {!r} tried to yield a value on close.  "
    ...
    async def _monitor(self, msg):
        ...
        try:
            ...
            raise IllegalMessageSequence(
                "A 'monitor' message was sent but no " "run is open."
            ) from ke
    ...
    async def _unmonitor(self, msg):
        ...
        try:
            ...
            raise IllegalMessageSequence(
                "A 'unmonitor' message was sent but no " "run is open."
            ) from ke
    ...
    async def _kickoff(self, msg):
        ...
        try:
            ...
            raise IllegalMessageSequence(
                "A 'kickoff' message was sent but no " "run is open."
            ) from ke
    ...
    async def _complete(self, msg):
        ...
        try:
            ...
            raise IllegalMessageSequence(
                "A 'complete' message was sent but no " "run is open."
            ) from ke
    ...
    async def _configure(self, msg):
        ...
        try:
            ...
            if current_run.bundling:
                raise IllegalMessageSequence(
                    "Cannot configure after 'create' but before 'save'" "Aborting!"
                )
        _, obj, args, kwargs, _ = msg
...
class Dispatcher:
    ...
    def process(self, name, doc):
        ...
        for exc, traceback in exceptions:
            warn(
                "A %r was raised during the processing of a %s "
