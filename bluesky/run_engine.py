...
class RunEngine:
    ...
    def __init__(self, md=None, *, loop=None, preprocessors=None,
                 ...
                 during_task=None, call_return_type='uids'):
        if loop is None:
        ...
        self._call_return_type = call_return_type  # should __call__ return UIDs or plan value
    ...
    def __call__(self, *args, **metadata_kw):
        ...
        Returns
        -------
        if instantiated with call_return_type = 'uids'
        uids : list
            list of uids (i.e. RunStart Document uids) of run(s)

        if instantiated with call_return_type = 'plan_return'
        ...
        if self._call_return_type == 'plan_return':
            run_engine_return = self._create_result(plan_return)
