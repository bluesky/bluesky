...
class RunEngine:
    ...
    def __init__(self, md=None, *, md_validator=None, logbook=None):
        ...
        self._configuration_cache = dict()  # cache of obj.configuration output
        self._configuration_times_cache = dict()  # cache when config was read
    ...
    def _clear_call_cache(self):
        ...
        self._configuration_times_cache.clear()
    ...
    def _read(self, msg):
        ...
        if obj not in self._describe_cache:
            ...
            self._configuration_cache[obj] = getattr(obj, 'configuration', {})
            self._configuration_times_cache[obj] = ttime.time()
    ...
    def _save(self, msg):
        ...
        if objs_read not in self._descriptor_uids:
            ...
            doc = dict(run_start=self._run_start_uid, time=ttime.time(),
                       ...
                       configuration_times=configuration_times)
    ...
    def _configure(self, msg):
        ...
        self._configuration_cache[obj] = new
        self._configuration_times_cache[obj] = ttime.time()
        return new
