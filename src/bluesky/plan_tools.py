...
def print_summary(plan):
    ...
    """
    warn(
        "bluesky.plan_tools.print_summary is deprecated. Use bluesky.simulators.summarize_plan instead.",
        stacklevel=1,
    )
...
def print_summary_wrapper(plan):
    ...
    """
    warn(
        "The bluesky.plan_tools module is deprecated. Use bluesky.simulators instead.",
        stacklevel=1,
    )
