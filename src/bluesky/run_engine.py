...
class RunEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self._status_objs: defaultdict[typing.Any, set[typing.Any]] = defaultdict(set)  # status objects to wait for
        self._temp_callback_ids: set[typing.Any] = set()  # ids from CallbackRegistry
        self._seen_wait_and_move_on_keys: set[typing.Any] = set()  # group ids that have been passed to _wait_and_move_on
